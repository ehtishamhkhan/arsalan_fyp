            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="col-12 mb-0">{{ __('Live Tracking') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <div>
...
<script defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxeU25rpIkBdnXCGBgOcMDUunPjOjDSks&callback=initMap">
</script>
