                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="row align-items-center col-lg-12 col-md-12">
                                <div class="card-body px-lg-5 py-lg-5">
                                    ...
                                    <form role="form" method="POST" action="{{ route('addnewdriver') }}">
                                        @csrf
                                        ...
                                        <div class="form-group{{ $errors->has('user_id') ? ' has-danger' : '' }}">
                                            <div class="input-group input-group-alternative mb-3">
                                                ...
                                                <input class="form-control{{ $errors->has('user_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Employee Id') }}" type="number" name="user_id" value="{{ old('user_id') }}" required autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary mt-4">{{ __('Add Driver') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
